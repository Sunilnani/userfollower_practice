...
class _UserFollowerState extends State<UserFollower> {
  ...
  void fetch_usersfollower() async {
    ...
    try {
      ...
      Response response = await dioClient.ref.get("/users/${widget.follower??0}/followers",
        // Response response=await dioClient.ref.get("/users/login=${widget.follower}/followers");
      );
      setState(() {
        follower =followersFromJson(jsonEncode(response.data)) ;
            ...
            InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      radius: 35,
                      backgroundImage: NetworkImage(follower![index].avatarUrl),
                    ),
                  ],
                )
            ),
...
//   Followers? follower;
//  // List<Followers>? follower=[];
//   //List<Followers> followers=Followers();
//
//
//   void fetch_usersfollower() async {
//     setState(() {
